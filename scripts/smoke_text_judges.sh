#!/bin/bash
#SBATCH --job-name=easynla_tj_smoke2
...
srun /workspace-vast/asherps/envs/vllm-lens/bin/python -m nla.train_rl_vllm \
    ...
    --save-dir /workspace-vast/asherps/exp/training/easynla_tj_smoke2 \
    --num-steps 12 --batch-prompts 16 --group-size 8 \
    --eval-every 4 --eval-n-prompts 16 --save-every 12 --text-judges-every 8 \
    --wandb-project easynla --wandb-name tj_smoke --wandb-tags text-judges-smoke
